...
QT_MOC_LITERAL(11, 97, 6), // "mainOn"
QT_MOC_LITERAL(12, 104, 11), // "lkasEnabled"
QT_MOC_LITERAL(13, 116, 14) // "adaptiveCruise"

    },
    "OnroadHud\0valueChanged\0\0speed\0speedUnit\0"
    "maxSpeed\0is_cruise_set\0engageable\0"
    "dmActive\0hideDM\0status\0mainOn\0lkasEnabled\0"
    "adaptiveCruise"
};
...
void OnroadHud::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: *reinterpret_cast< bool*>(_v) = _t->mainOn; break;
        case 9: *reinterpret_cast< bool*>(_v) = _t->lkasEnabled; break;
        case 10: *reinterpret_cast< bool*>(_v) = _t->adaptiveCruise; break;
        default: break;
        }
        ...
        case 7:
            ...
            break;
        case 8:
            if (_t->mainOn != *reinterpret_cast< bool*>(_v)) {
                _t->mainOn = *reinterpret_cast< bool*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        case 9:
            ...
            break;
        case 10:
            if (_t->adaptiveCruise != *reinterpret_cast< bool*>(_v)) {
                _t->adaptiveCruise = *reinterpret_cast< bool*>(_v);
                Q_EMIT _t->valueChanged();
            }
            break;
        default: break;
